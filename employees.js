...
empOne.getSchedule(empOne.names,empOne.shifts);
...
class Manager extends employee {
    constructor(names, shift, newEmployees) { 
    super(names, shift) 
...
//CODE HERE
let employeesReport = ['Cece','Schmidt'];
let manager = new Manager('Winston', 'weekday mornings and weekdayafternoons',employeesReport)
...
//CODE HERE
manager.getEmployees(manager.names,manager.newEmployees);
