...
console.log("dot notation   " +pizza.popularity);
...
//CODE HERE
let {tags} = pizza
console.log("dot notation   " +pizza.tags[1]);
console.log(`bracketNotation: +  ${tags[1]}`);
...
//CODE HERE
let filteredArray1 = filterByProperty('popularity',15,'above');
