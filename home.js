...
let canweTwo = canWeDeliver(11234);
console.log(canwe);
...
//const offers = deals.splice(2, 1, "title: 'BOB'", "desc: 'This deal lasts until the end of March!'")
//console.log(offers)
//console.log(deals)
